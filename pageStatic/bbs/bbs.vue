<template>
	<view>
		<view class="row">
			<view class="jz">
				<image src="https://6465-dev-iey4o-1257667322.tcb.qcloud.la/bbs.png?sign=9316f53bdfc0ef61d7049ecfc425f685&t=1567401140"
				 mode=""></image>
			</view>
			<view class="li">
				...
				<block v-for="(item,index) of list" :key='index' v-else>
					<view class="item">
						<view @tap="toDetial(item.id)">
							<!-- <uni-badge  type="error" size="small" v-if='item.forumShowType==3' /> -->
							<view class="headers">
								{{item.title}}
							</view>
							<view class="content">
						...
						<view class="bottom" v-if='state&&item.forumShowType==1'>
