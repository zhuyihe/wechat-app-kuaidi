					 ...
					 v-show="!upImgConfig.isAddImage || false">
						<view>
							<text class="iconfont" :class="[upImgConfig.upIconName==undefined?'icon-shangchuantupian':upImgConfig.upIconName]"
							 style="font-size: 72upx;margin-bottom: 12upx;color:#999" :style="'color:'+upImgConfig.upIconColor+';width:100%;color:#999'"></text>
						</view>
						<view class="icon-text" :style="'color:'+upImgConfig.upIconColor+';width:100%;'">{{upImgConfig.upTextDesc==undefined ||upImgConfig.upTextDesc==''?'':upImgConfig.upTextDesc}}</view>
					</view>
				</view>
				<view class='sunsin_picture_item sunsin_width' v-show="upload_picture_list.length<upImgConfig.count || upImgConfig.notli"
				 v-else>
