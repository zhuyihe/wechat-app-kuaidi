	...
	export default {
		...
		methods: {
			...
			createCanvasImage() {
				...
				let closeBtn =
					'https://6465-dev-iey4o-1257667322.tcb.qcloud.la/close.png?sign=db6d8d0a3f12c1854ffd5b9e72db33dc&t=1569723017'
				console.log(ctx)
				console.log(this)
				...
				ctx.font = 'normal bold 14px sans-serif';
				ctx.fillText('奇校园小程序', (_this.phoneW - 90) / 2, 530 * scaleH, 90);
				// 小程序的名称end
				// 长按/扫描识别查看商品
				ctx.setFontSize(14)
